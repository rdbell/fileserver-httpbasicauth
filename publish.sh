...
docker build --platform linux/amd64 -t rdbell/fileserver-httpbasicauth:latest -t rdbell/fileserver-httpbasicauth:$VER . &&
docker push rdbell/fileserver-httpbasicauth:$VER
docker push rdbell/fileserver-httpbasicauth:latest
